...
//            ]
//        }
        List<SysMenu> resultList = MenuHelper.buildTreeMenu(sysMenuList);
        return resultList;
    }
    ...
    public List<SysMenu> findMenuByRoleId(Long roleId) {
        ...
        //4 返回规定树形显示格式菜单列表
        List<SysMenu> sysMenuList = MenuHelper.buildTreeMenu(allSysMenuList);
        return sysMenuList;
    }
    ...
    public List<RouterVo> findUserMenuListByUserId(Long userId) {
        ...
        //使用菜单操作工具类构建树形结构
        List<SysMenu> sysMenuTreeList = MenuHelper.buildTreeMenu(sysMenuList);
        //构建成框架要求的路由结构
